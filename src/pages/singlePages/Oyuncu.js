      ...
      <div className="singlePage">  
        <div className="singlePage__aside">
          <div className="klup__left__top">
              <div className="header">Teknik Kapasite</div>
              <div className="block"></div>
              <div className="message">{singlePost.teknik}</div>
              <div className="submessage">Genel</div>
            </div>
            <div  className="klup__left__middle">
              <div className="header">Oyun Görüşü</div>
              <div className="block"></div>
              <div className="message">{singlePost.vizyon}</div>
              <div className="submessage">Genel</div>                 
            </div>
            <div  className="klup__left__middle">
              <div className="header">Fiziksel Kapasite</div>
              <div className="block"></div>
              <div className="message">{singlePost.fizik}</div>
              <div className="submessage">Genel</div>                 
            </div>
            <div  className="klup__left__middle">
              <div className="header">Mental</div>
              <div className="block"></div>
              <div className="message">{singlePost.mental}</div>
              <div className="submessage">Genel</div>                 
            </div>
        </div>
