      ...
      <div className="singlePage">  
        <div className="singlePage__aside">
          <div className="klup__left__top">
              <div className="header">Maçın Adamı</div>
              <div className="block"></div>
              <div className="message">{singlePost.macinAdami}</div>
              <div className="submessage">10.0 üzerinden</div>
          </div>
          <div  className="klup__left__middle">
              <div className="header">Maç Kalitesi</div>
              <div className="block"></div>
              <div className="message">{singlePost.kalite}</div>
              <div className="submessage">10.0 üzerinden</div>                 
          </div>
        </div>
