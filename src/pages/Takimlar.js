    ...
    .map((data,index) => {
      return (
        <div className="kulup__cart" key={index} >
              ...
              <Link to={"/takimlar/" + data.slug.current} key={data.slug.current} className="kulup__link" >Devamı...</Link>
        ...
        <div className="kulup">
          ...
          <div className="klup__left" key={index}>
            <div className="klup__left__top" >
              <div className="header">Yılın Takımı</div>
              <div className="block"></div>
              <div className="message"> {data.yilintakimi} </div>
            </div>
            
            <div  className="klup__left__middle">
              <div className="header">Ayın Takımı</div>
              <div className="block"></div>
              <div className="message">{data.ayintakimi}</div>      
            </div>
            <div  className="klup__left__middle">
              <div className="header">Haftanın Takımı</div>
              <div className="block"></div>
              <div className="message">{data.haftanintakimi}</div>             
            </div>
          </div>
            ))}
          ...
          <aside className="kulup__right">
            ...
            <div className="kulup__right__top">
              <div className="baslik">Kulup</div>
            {kulup && kulup.map((data,index) => (
              <ul  key={index}  className="side__content">
                ...
                <div className="hey" >
                  ...
                  <li>
                    <Link  to={"/kulup/" + data.slug.current} key={data.slug.current} className="side_data" > Devamı...  </Link>
                  </li>
                </div>
                : null  }
              </ul>
