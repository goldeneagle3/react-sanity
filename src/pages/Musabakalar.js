    ...
    .map((data,index) => {
      return (
        <div className="kulup__cart" key={index} >
              ...
              <Link to={"/musabakalar/" + data.slug.current} key={data.slug.current} className="kulup__link" >Devamı...</Link>
